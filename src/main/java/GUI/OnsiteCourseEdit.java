...
public class OnsiteCourseEdit extends javax.swing.JPanel {
        ...
        private void initComponents() {
                ...
                jComboBoxDepartmentID
                                .setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "4", "7" }));
                                                                ...
                                                                .addGroup(jPanel2Layout.createParallelGroup(
                                                                                ...
                                                                                .addGroup(jPanel2Layout
                                                                                                ...
                                                                                                .addGroup(jPanel2Layout
                                                                                                                ...
                                                                                                                .addComponent(jComboBoxDepartmentID,
                                                                                                                                0,
        ...
        public void updateOnSiteCourse() {
                ...
                int departmnetIndex = department.lastIndexOf(" ");
                int departmentID = Integer.parseInt(department.substring(departmnetIndex + 1));
                CourseBLL.getInstance().add(new CourseDTO(courseID, title, credits, departmentID));
                CourseBLL.getInstance().refresh();

                CourseDTO courseDTO = new CourseDTO(courseID, title, credits, departmentID);
                OnsiteCourseDTO onsiteCourseDTO = new OnsiteCourseDTO(courseID, title, credits, departmentID,
                                txtLocation.getText(), txtDay.getText(), time);

                CourseBLL.getInstance().updateCourse(courseDTO);
                OnsiteCourseBLL.getInstance().updateOnsiteCourse(onsiteCourseDTO);
        ...
        public void setCourseData(CourseDTO courseDTO, OnsiteCourseDTO onsiteCourseDTO) {
                txtCourseID.setText(courseDTO.getCourseId() + "");
                txtTitle.setText(courseDTO.getTitle());
                txtCredits.setText(String.valueOf(courseDTO.getCredits()));
                jComboBoxDepartmentID.setSelectedItem(String.valueOf(courseDTO.getDepartmentId()));
                txtLocation.setText(onsiteCourseDTO.getLocation());
                txtDay.setText(onsiteCourseDTO.getDays());
                txtTime.setText(onsiteCourseDTO.getTime().toString());
            }
