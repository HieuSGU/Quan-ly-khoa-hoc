...
public class OnsiteCourseMainForm extends javax.swing.JPanel {
    ...
    public OnsiteCourseMainForm(Main main) {
        ...
        jTextField4.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int searchText = Integer.parseInt(jTextField4.getText());
    ...
    // End of variables declaration//GEN-END:variables
        ...
        try {
            ...
            ArrayList<OnsiteCourseDTO> courses = onSiteCourseBLL.search(id);

            for (OnsiteCourseDTO course : courses) {
                Object[] rowData = {course.getCourse().getCourseId(), course.getCourse().getTitle(), course.getLocation(), course.getDays(), course.getTime()};
